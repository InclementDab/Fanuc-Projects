...
/*                                                                   */
/* Copyright (C) 2003-2014 by FANUC CORPORATION All rights reserved. */
/*                                                                   */
/*-------------------------------------------------------------------*/
...
typedef struct out_dsinfo {
    ...
    ULONG   remain_h;   /* remain(high) */
    ULONG   remain_l;   /* remain(low) */
...
typedef struct _odbsramif2 {
    LONG            protect;    /* protective state of File SRAM */
    ULONG   adrs;       /* address of File SRAM */
    LONG            size;       /* size of File SRAM */
} ODBSRAMIF2;
...
typedef struct rmtdgn_info {
    ULONG  receipt_num;	    /* Receipt Number   */
    ULONG  time;            /* Time             */
    short          status;          /* Status           */
...
typedef struct odbpwcmdat {
    ULONG time ;           /* Integrating time of power consumption */
...
typedef struct odbpmcadr {
	...
	ULONG  adr ;		/* offset address from the top of the PMC address area */
	ULONG  top ;		/* top number of the PMC address area */
	ULONG  num ;		/* number of the PMC address area */
} ODBPMCADR ;
...
typedef struct _out_ethtype2 {
    ...
    short                   dummy;
    ULONG           FunctionEmb;
    ULONG           FunctionEmbPcm;
    ULONG           FunctionBoard;
    ULONG           FunctionEmbCe;
    ULONG           FunctionEmbCePcm;
} OUT_ETHTYPE2;
...
typedef struct _out_fl_devtype {
    ...
    ULONG           FunctionFLnet1;
    unsigned short          Kind2;
    unsigned char           pad2[2];
    ULONG           FunctionFLnet2;
} FL_DEVTYPE;
...
typedef struct  iodbrtmior {
	...
	ULONG sno;	/* DI/DO variable access enable start no. */
	ULONG eno;	/* DI/DI variable access enable end no. */
} IODBRTMIOR ;
...
typedef struct _out_flntlog {
    ...
    ULONG   RecvMsgErr;
    ULONG   AckErr;
    ULONG   DuplicatedToken;
    ULONG   DestroyedToken;
    ULONG   ReissueToken;
    ULONG   FrameWait;
    ULONG   Entry;
    ULONG   OutRing;
...
typedef struct _out_flntdevinfo {
    unsigned short      Kind;
    short               dummy;
    ULONG       FunctionFLnetBoard;
    ULONG       FunctionFLnetEmb;
    ULONG       FunctionFLnetCard;
} OUT_FLNTDEVINFO;
...
typedef struct odbpmcaxisinfo {
	...
	ULONG	axisctrldata;	/* data signal */
	unsigned short	subinstnum;		/* subinstruction number */
	unsigned short	subinstlength;	/* data length of subinstruction */
	ULONG	subinstdata1;	/* subinstruction data 1 */
	ULONG	subinstdata2;	/* subinstruction data 2 */
	ULONG	subinstdata3;	/* subinstruction data 3 */
	ULONG	subinstdata4;	/* subinstruction data 4 */
	ULONG	subinstdata5;	/* subinstruction data 5 */
	ULONG	subinstdata6;	/* subinstruction data 6 */
	ULONG	subinstdata7;	/* subinstruction data 7 */
} ODBPMCAXISINFO;
...
typedef struct odbmddinfo {
    ...
    short           min;            /*            minute */
    short           sec;            /*            second */
    ULONG   reg_code;       /* Check code - registered */
    ULONG   cur_code;       /* Check code - current */
...
typedef struct odbusbsize {
    ULONG    totalsize_h;      /* total size (high) */
    ULONG    totalsize_l;      /* total size (low)  */
    ULONG    freesize_h;       /* free size (high)  */
    ULONG    freesize_l;       /* free size (low)   */
} ODBUSBSIZE;
...
typedef struct odbusbinfo {
    ...
    char            dummy;
	ULONG   total;      /* number of total files             */
} ODBUSBINFO;
/* file information */
...
/* merge program */
FWLIBAPI short WINAPI cnc_mergeprog( unsigned short, short, LONG, ULONG, LONG );
...
FWLIBAPI short WINAPI cnc_rdprogline( unsigned short, LONG, ULONG, char *, ULONG *, ULONG * );
FWLIBAPI short WINAPI cnc_rdprogline2( unsigned short, LONG, ULONG, char *, ULONG *, ULONG * );
FWLIBAPI short WINAPI cnc_rdprogdata( unsigned short, LONG, ULONG, char *, ULONG *, ULONG * );

/* line edit (write program) */
FWLIBAPI short WINAPI cnc_wrprogline( unsigned short, LONG, ULONG, char *, ULONG );

/* line edit (delete line in program) */
FWLIBAPI short WINAPI cnc_delprogline( unsigned short, LONG, ULONG, ULONG );

/* line edit (search string) */
FWLIBAPI short WINAPI cnc_searchword( unsigned short, LONG, ULONG, short, short, ULONG, char * );
#endif

FWLIBAPI short WINAPI cnc_searchword2( unsigned short, LONG, ULONG, short, short, ULONG, char * );
FWLIBAPI short WINAPI cnc_pdf_searchword( unsigned short, char *, ULONG, ULONG, ULONG, ULONG, char * );
FWLIBAPI short WINAPI cnc_pdf_searchword_bgedt( unsigned short, char *, ULONG, ULONG, ULONG, ULONG, char * );

/* line edit (search string in Data Server) */
FWLIBAPI short WINAPI cnc_pdf_dssearch( unsigned short, char *, ULONG, ULONG, ULONG, ULONG, char *,short );

/* line edit (search string) */
#ifndef CNC_PPC
FWLIBAPI short WINAPI cnc_searchresult( unsigned short, ULONG * );
#endif
FWLIBAPI short WINAPI cnc_searchresult2( unsigned short, ULONG * );
FWLIBAPI short WINAPI cnc_pdf_searchresult( unsigned short, ULONG * );
FWLIBAPI short WINAPI cnc_pdf_searchresult2( unsigned short, ULONG * );
FWLIBAPI short WINAPI cnc_pdf_searchresult_bgedt( unsigned short, ULONG * );

/* replace all words */
FWLIBAPI short WINAPI cnc_pdf_replaceword_all( unsigned short, char *, ULONG, ULONG, ULONG, char *, char * );
...
FWLIBAPI short WINAPI cnc_rdpdf_line( unsigned short, char *, ULONG, char *, ULONG *, ULONG * );
FWLIBAPI short WINAPI cnc_rdpdf_line2( unsigned short, char *, ULONG, char *, ULONG *, ULONG * );
FWLIBAPI short WINAPI cnc_rdpdf_line_bgedt( unsigned short, char *, ULONG, char *, ULONG *, ULONG * );
FWLIBAPI short WINAPI cnc_rdpdf_execline( unsigned short, char *, ULONG, char *, ULONG *, ULONG * );

/* line edit (write program by file name) */
FWLIBAPI short WINAPI cnc_wrpdf_line( unsigned short, char *, ULONG, char *, ULONG );

/* line edit (delete line by file name) */
FWLIBAPI short WINAPI cnc_pdf_delline( unsigned short, char *, ULONG, ULONG );

/* chara edit (write program by file name)	 */
FWLIBAPI short WINAPI cnc_wrpdf_char( unsigned short, char *, ULONG, ULONG, char *, ULONG );

/* char edit (delete character by file name) */
FWLIBAPI short WINAPI cnc_pdf_delchar( unsigned short, char *, ULONG, ULONG, ULONG );

/* char edit (replace character by file name)*/
FWLIBAPI short WINAPI cnc_pdf_replacechar(unsigned short, char *, ULONG, ULONG, ULONG, char *, ULONG );
...
FWLIBAPI short WINAPI cnc_punch_data_start( unsigned short, short, ULONG, ULONG, char * );
FWLIBAPI short WINAPI cnc_punch_data_end( unsigned short, ULONG *, ULONG *, short * );
...
FWLIBAPI short WINAPI cnc_mcdp_wractpt(unsigned short, char *, LONG, ULONG *);
...
/* merge program */
FWLIBAPI short WINAPI cnc_pdf_mergeprog(unsigned short, short, char *, ULONG, ULONG, char *);
...
/* read cnc id */
FWLIBAPI short WINAPI cnc_rdcncid( unsigned short, ULONG * );
...
FWLIBAPI short WINAPI cnc_rdmacror2( unsigned short, ULONG, ULONG *, double * ) ;
FWLIBAPI short WINAPI cnc_rdmacror2_name( unsigned short, ULONG, ULONG *, IODBMRN *pdb ) ;
#endif
FWLIBAPI short WINAPI cnc_rdmacror3( unsigned short, ULONG, ULONG *, IODBMRN3 *pdb ) ;
FWLIBAPI short WINAPI cnc_rdmacror4( unsigned short, ULONG, ULONG *, IODBMRN4 *pdb ) ;

/* write custom macro variables(IEEE double version) */
FWLIBAPI short WINAPI cnc_wrmacror2( unsigned short, ULONG, ULONG *, double * ) ;
...
FWLIBAPI short WINAPI cnc_rdmacronum( unsigned short, char *, ULONG, ULONG *, short * ) ;
...
FWLIBAPI short WINAPI cnc_rdpmacror2( unsigned short, ULONG, ULONG *, unsigned short, double * );

/* write P code macro variables(IEEE double version) */
FWLIBAPI short WINAPI cnc_wrpmacror2( unsigned short, ULONG, ULONG *, unsigned short, double * );

/* read P code macro variables(Back ground version) */
FWLIBAPI short WINAPI cnc_rdpmacror_bg( unsigned short, ULONG, ULONG *, double * );

/* write P code macro variables(Back ground version) */
FWLIBAPI short WINAPI cnc_wrpmacror_bg( unsigned short, ULONG, ULONG *, double * );
...
FWLIBAPI short WINAPI cnc_rdtlnewstatus( unsigned short, ULONG * ) ;
...
FWLIBAPI short WINAPI cnc_rdcmstatdata( unsigned short, ULONG * ) ;
...
FWLIBAPI short WINAPI cnc_unsolicstart( unsigned short FlibHndl, short number, HWND hWnd, ULONG msgno, short chkalive, short *bill );
...
FWLIBAPI short WINAPI cnc_rdftrq_data( unsigned short, short, LONG, short*, ULONG * );
...
/* read CNC memory */
FWLIBAPI short WINAPI cnc_rdcncmem( unsigned short, short, ULONG, ULONG, void* );

/* write CNC memory */
FWLIBAPI short WINAPI cnc_wrcncmem( unsigned short, short, ULONG, ULONG, void* );
...
FWLIBAPI short WINAPI cnc_rdfsraminfo( unsigned short, ULONG, ODBSRAMIF * );
FWLIBAPI short WINAPI cnc_rdfsraminfo2( unsigned short, ULONG, ODBSRAMIF2 * );

/* Read File SRAM */
FWLIBAPI short WINAPI cnc_rdfile_sram( unsigned short, ULONG, ULONG, LONG, char * );

/* Write File SRAM */
FWLIBAPI short WINAPI cnc_wrfile_sram( unsigned short, ULONG, ULONG, LONG, char * );
...
FWLIBAPI short WINAPI cnc_3dchk_rddata3(unsigned short, ULONG *, ODB3DCHK [], short [], ODB3DMTBINFO [] );

/* Reads 3D interference chaeck data(4) */
FWLIBAPI short WINAPI cnc_3dchk_rddata4(unsigned short, ULONG *, ODB3DCHK [], short *, ODB3DMTBINFO2 [] );
...
FWLIBAPI short WINAPI cnc_3dchk_getprginfo(unsigned short, ULONG *, char *, LONG *);
...
FWLIBAPI short WINAPI cnc_rdcncmem2( unsigned short, short, ULONG, ULONG, void*, short );

/* write option board memory */
FWLIBAPI short WINAPI cnc_wrcncmem2( unsigned short, short, ULONG, ULONG, void*, short );
...
FWLIBAPI short WINAPI cnc_chkversion( unsigned short, ULONG* condition);
...
FWLIBAPI short WINAPI cnc_rdmtdtnid( unsigned short, ULONG *);
...
FWLIBAPI short WINAPI cnc_rdedmcram( unsigned short, ULONG, short, LONG *, void * ) ;

/* Write data to HSSB CRAM for EDM */
FWLIBAPI short WINAPI cnc_wredmcram( unsigned short, ULONG, short, LONG *, void * ) ;
...
FWLIBAPI short WINAPI cnc_wrsignal_f(unsigned short, short, ULONG);

/* NCGuide protect cancel */
FWLIBAPI short WINAPI cnc_ncg_protcancel( unsigned short, char *, LONG );

#ifndef CNC_PPC
FWLIBAPI short WINAPI cnc_set_prps( unsigned short, short, char *, ULONG );
FWLIBAPI short WINAPI cnc_reset_prps( unsigned short, short, char * );
FWLIBAPI short WINAPI cnc_status_prps( unsigned short, short, LONG * );
#endif
...
FWLIBAPI short WINAPI cnc_sdfmnghwnd( unsigned short, short, HWND, ULONG );
...
FWLIBAPI short WINAPI cnc_rdcexefile( unsigned short, unsigned char *, ULONG * );

/* write C-EXE SRAM file */
FWLIBAPI short WINAPI cnc_wrcexefile( unsigned short, unsigned char *, ULONG * );
...
FWLIBAPI short WINAPI pmc_rdkpm( unsigned short, ULONG, char *, unsigned short ) ;

/* write data to extended backup memory */
FWLIBAPI short WINAPI pmc_wrkpm( unsigned short, ULONG, char *, unsigned short ) ;

/* read data from extended backup memory 2 */
 FWLIBAPI short WINAPI pmc_rdkpm2( unsigned short, ULONG, char *, ULONG ) ;

/* write data to extended backup memory 2 */
 FWLIBAPI short WINAPI pmc_wrkpm2( unsigned short, ULONG, char *, ULONG ) ;

/* read maximum size of extended backup memory */
FWLIBAPI short WINAPI pmc_kpmsiz( unsigned short, ULONG * ) ;
...
FWLIBAPI short WINAPI pmc_wriolinkdat( unsigned short, LONG, LONG, ULONG, void *, ULONG ) ;

/* read PMC address information */
FWLIBAPI short WINAPI pmc_rdpmcaddr( unsigned short, LONG, unsigned short, ULONG, ODBPMCADR * );
...
FWLIBAPI short WINAPI eth_ping( unsigned short, short, char *, ULONG * );
...
/* search file */
FWLIBAPI short WINAPI cnc_dssearch( unsigned short, char*, char*, unsigned short, ULONG*  );
...
FWLIBAPI short WINAPI cnc_rdflnetsram(unsigned short, short, ULONG, ULONG *, void *);

/* Write FL-net Sram area (for 16i Series)  */
FWLIBAPI short WINAPI cnc_wrflnetsram(unsigned short, short, ULONG, ULONG *, void *);
...
FWLIBAPI short WINAPI cnc_allclibhndl4( const char *, unsigned short, LONG, ULONG, unsigned short * );
...
FWLIBAPI short WINAPI cnc_getrtmioinfo ( unsigned short, short, IODBRTMIOR *, ULONG * ) ;

/* get the number of real-time custom macro di/do variable range index */
FWLIBAPI short WINAPI cnc_getrtmiorngnum ( unsigned short, ULONG * ) ;

/* read real-time custom macro di/do variables write enable information */
FWLIBAPI short WINAPI cnc_rdrtmiowrenbl ( unsigned short, IODBRTMIO *, ULONG *, char * ) ;

/* write real-time custom macro di/do variables write enable status (per byte) */
FWLIBAPI short WINAPI cnc_wrrtmiowrenbl ( unsigned short, IODBRTMIO *, ULONG *, char * ) ;
...
FWLIBAPI short WINAPI cnc_rdrtmiowrenblrng ( unsigned short, IODBRTMIOR *, LONG, ULONG * ) ;

/* write real-time custom macro di/do variables write enable status (valid range) */
FWLIBAPI short WINAPI cnc_wrrtmiowrenblrng ( unsigned short, IODBRTMIOR *, LONG, ULONG * ) ;
...
FWLIBAPI short WINAPI cnc_searchusbfile(unsigned short, IDBUSBSEARCH *, ULONG *);
...
/* Auxiliary status       */
/*------------------------*/
FWLIBAPI short WINAPI cnc_aux_statinfo(unsigned short h, ULONG *stat);
...
FWLIBAPI short WINAPI cnc_powc_rd_clear_time(unsigned short h, ULONG *clear_time);
...
FWLIBAPI short WINAPI cnc_rd_hm_cmpl_stat(unsigned short, LONG *, ULONG *, short *, short *);
...
FWLIBAPI short WINAPI cnc_rdprgrmupdtcnt(unsigned short, ULONG*);
...
FWLIBAPI short WINAPI cnc_tprog_rdline( unsigned short, char *, LONG, char *, ULONG *, ULONG *);
...
/*---------------------------------------------------*/
FWLIBAPI short WINAPI cnc_rdecamdatar(unsigned short, ULONG, ULONG *, LONG *);
FWLIBAPI short WINAPI cnc_wrecamdatar(unsigned short, ULONG, ULONG *, LONG *);
...
FWLIBAPI short WINAPI cnc_rct_wrRecom  (unsigned short, short, short );
...
FWLIBAPI short WINAPI cnc_rct_cpSlctPtn(unsigned short, short, unsigned short, unsigned short );
...
#ifndef _WINDOWS
/*ins Linux add functions information ins*/ /* <- Never delete this line. */
/*---------------------------------------*/
